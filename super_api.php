...
sendaction($chat_id, typing);
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	  [
	  ['text'=>"الصور",'url'=>"http://telegram.me/iimaii"],['text'=> "$photo1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"الروابط",'url'=>"http://telegram.me/iimaii"],['text'=> "$link1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"الاغاني",'url'=>"http://telegram.me/iimaii"],['text'=> "$audio1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"البصمات",'url'=>"http://telegram.me/iimaii"],['text'=> "$voice1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"الفيديو",'url'=>"http://telegram.me/iimaii"],['text'=> "$video1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"الملصقات",'url'=>"http://telegram.me/iimaii"],['text'=> "$sticker1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
   [
	  ['text'=>"التوجيه",'url'=>"http://telegram.me/iimaii"],['text'=> "$fwd1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"المحادثة",'url'=>"http://telegram.me/iimaii"],['text'=> "$text1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"الالعاب",'url'=>"http://telegram.me/iimaii"],['text'=> "$game1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"الملفات",'url'=>"http://telegram.me/iimaii"],['text'=> "$doc1" ,'url'=>"http://telegram.me/iimaii"]
	  ],
	  [
	  ['text'=>"التثبيت",'url'=>"http://telegram.me/iimaii"],['text'=> "$pin1" ,'url'=>"http://telegram.me/iimaii"]
	  ]
   ]
   ])
   ]);
...
Click to you want and get a order your Gp🚨",
   ...
   [
  	['text'=>"🎭 Devs «~»  المطورين 🎭",'callback_data'=>"dev"]
	  ]
   ]
   ])
   ]);
...
sendaction($chat_id, typing);
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
 	 [
	  ['text'=>"تابع 🌐" ,'url'=>"http://telegram.me/iimaii"]
	  ]
   ]
   ])
   ]);
